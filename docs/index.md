...
**[Research it.](first-recipe.html)** You name a dish. Pan Out pulls from recipes, food science, and technique guides, cross-validates temperatures and times, and compiles everything into a step-by-step protocol tuned to your kitchen, your equipment, and your preferences.

**[Cook it.](first-cook.html)** Before anything hits the pan, it asks what you're working with — a kilo of chuck, half a bag of onions, feeding two or feeding ten. It adjusts the entire plan to match. Then at the stove, Pan Out becomes your sous-chef — it stays one step ahead of you, tells you what to do next, watches the timers, checks your temperatures, and tells you what to look for instead of just how long to wait. When you're braising for two hours, it tells you to walk away and calls you back when something needs attention.

**[Learn from it.](after-you-cook.html)** After you eat, a quick debrief captures what worked and what didn't. Timing adjustments, technique discoveries, seasoning preferences — all written back into the protocol so next time starts where this time left off.
